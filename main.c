...
/**
 *https://github.com/mukundimangena/3096-Pracs-MNGBLE005/blob/main/main.c
  ******************************************************************************
  * @file           : main.c
...
uint32_t pollADC(void){
  // TODO: Complete function body to get ADC val
     uint32_t val;
     HAL_ADC_Start(&hadc);//to start the conversion

     HAL_ADC_PollForConversion(&hadc, 1);//POll the adc

     val = HAL_ADC_GetValue(&hadc);// Get the adc result
...
uint32_t ADCtoCCR(uint32_t adc_val){
  // TODO: Calculate CCR val using an appropriate equation
	uint16_t val = (47999/4096)*adc_val;
